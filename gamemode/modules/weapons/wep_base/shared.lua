...
function SWEP:CSShootBullet( dmg, recoil, numbul, cone )
	...
	local bullet = {}
	local pHL2MPPlayer = pPlayer; //Sadoku added
	bullet.Num 		= numbul
	...
	bullet.Damage	= dmg
	bullet.Attacker = pPlayer; //Sadoku added
	...
	bullet.Callback = function( attacker, trace, dmginfo )
		...
		bullet.Weapon:FirePenetratingBullets( attacker, trace, dmginfo );

		return bullet:ShootCallback( attacker, trace, dmginfo );
...
/*---------------------------------------------------------
   ...
   Desc: A convenience function to shoot bullets //Sadoku Added
---------------------------------------------------------*/
